...
def main():
    ...
    shipping_pos2 = [2.1, 1.3]  # The new, second destination
    ...
    if result == TaskResult.SUCCEEDED:
        ...
        if service_call_successful_and_complete:
            navigator.get_logger().info(
                "Attempting to update robot footprint parameters..."
            )
            set_node_parameter(
                navigator,
            ...
            if shipping_result == TaskResult.SUCCEEDED:
                ...
                # Let's use the same orientation for the second goal
